...
class ControllerModuleOCFilter extends Controller {
  ...
  public function initialise() {
    ...
    $style = 'catalog/view/theme/rentacenter/css/ocfilter.css';

    if (version_compare(VERSION, '2.2', '<') == true) {
  		if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/css/ocfilter.css')) {
  			$style = 'catalog/view/theme/' . $this->config->get('config_theme') . '/css/ocfilter.css';
  		}

                    ...
                    <form action="<?php echo $action; ?>" method="post" id="booking-form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 pad-right">
                            ...
                            <div class="pasport-form">
                                ...
                                <label class="address-fact"><em>*</em>Фактический адрес проживания: <input type="text" name="address" id="address" placeholder="Фактический адрес проживания" value=""></label>

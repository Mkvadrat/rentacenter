                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-6 pad-left">
                            <p class="form-title">
                                ...
                                <label class="surname"><?php if ($error_surname) { ?>
                                <div class="text-danger"><?php echo $error_surname; ?></div>
                                <?php } ?><em>*</em>Фамилия:<input type="text" name="surname" placeholder="Фамилия" value=""></label>

                                <label class="name"><?php if ($error_name) { ?>
                                <div class="text-danger"><?php echo $error_name; ?></div>
                                <?php } ?><em>*</em>Имя: <input type="text" name="name" placeholder="Имя:" value=""></label>

                                <label class="patronymic"><?php if ($error_patronymic) { ?>
                                <div class="text-danger"><?php echo $error_patronymic; ?></div>
                                <?php } ?><em>*</em>Отчество:<input type="text" name="patronymic" placeholder="Отчество" value=""></label>
                                ...
                                <?php } ?>
                                <label class="primary-phone"><?php if ($error_phone) { ?>
                                <div class="text-danger"><?php echo $error_phone; ?></div>
                                <?php } ?><em>*</em>Основной номер телефона: <input type="tel" name="phone" placeholder="+7 (123) 456 78 9" value=""></label>
                            </div>
                        </div>
                        <div class="col-md-6 pad-right">
                            ...
                            <div class="pasport-form">
                                <label class="number"><?php if ($error_serial) { ?>
                                <div class="text-danger"><?php echo $error_serial; ?></div>
                                <?php } ?><em>*</em>Серия и номер:<input type="text" name="serial" placeholder="Отчество" value=""></label>
                                ...
                                <label class="issued"><?php if ($error_issued_by) { ?>
                                <div class="text-danger"><?php echo $error_issued_by; ?></div>
                                <?php } ?><em>*</em>Кем выдан: <input type="text" name="issued_by" placeholder="123456789" value=""></label>

                                <label class="address"><?php if ($error_registration) { ?>
                                <div class="text-danger"><?php echo $error_registration; ?></div>
                                <?php } ?><em>*</em>Адрес регистрации: <input type="text" name="registration" placeholder="123456789" value=""></label>

                                <label class="address-fact"><?php if ($error_address) { ?>
                                <div class="text-danger"><?php echo $error_address; ?></div>
                                <?php } ?><em>*</em>Фактический адрес прожимания: <input type="text" name="address" placeholder="123456789" value=""></label>

                                <p class="form-title form-title-pasport">
                                Водительские права
                                </p>
                                <label class="number"><?php if ($error_license) { ?>
                                <div class="text-danger"><?php echo $error_license; ?></div>
                                <?php } ?><em>*</em>Серия и номер:<input type="text" name="license" placeholder="123456789" value=""></label>
                        ...
                        <div class="col-md-12 pad-left pad-right">
                            ...
                            <div class="more-info-form">
                                <label class="place-birth"><?php if ($error_city) { ?>
                                <div class="text-danger"><?php echo $error_city; ?></div>
                                <?php } ?><em>*</em>Место рождения: <input type="text" name="city" placeholder="г. Ростов-на-Дону" value=""></label>
                                ...
                                <label class="car-supply"><?php if ($error_issue_place) { ?>
                                <div class="text-danger"><?php echo $error_issue_place; ?></div>
                                <?php } ?><em>*</em>Место подачи авто: <input type="text" name="issue_place" placeholder="г. Ростов-на-Дону" value=""></label>

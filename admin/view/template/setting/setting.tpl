        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mobile-telephone">Мобильный телефон</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_mobile_telephone" value="<?php echo $config_mobile_telephone; ?>" placeholder="Мобильный телефон" id="input-mobile-telephone" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-twitter">Социальные сети (Twitter)</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" placeholder="Социальные сети (Twitter)" id="input-twitter" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
